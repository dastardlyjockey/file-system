...
from .users.users import fastapi_users, auth_backend
...
async def delete_post(post_id: str, db: AsyncSession = Depends(get_sync_session)):
    try:
        ...
        return {"success": True, "message": "The post is successfully deleted"}
